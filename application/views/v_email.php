                                                    ...
                                                    <td valign='top' align='center'>
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable">
																...
																<img src="http://sim.id/simpro/assets/londinium/images/simpro_logo.png" style="width:40%;" /> 
                                                        ...
                                                        <div class="contentEditableContainer contentTextEditable">
                                                            <div class="contentEditable" align='center'>
                                                                ...
                                                                <p style='text-align:left;color:#222222;font-size:14px;font-weight:normal;line-height:19px;'>
                                                                    ...
                                                                    Permintaan SIMPRO Anda telah kami terima, silahkan konfirmasi permintaaan anda dengan klik tombol di bawah ini.<br />

                                                                
                                                                    <br>
                                                                    <br>
                                                                    <a href="<?php echo base_url()."notification?id=".$reg_no; ?>" style="background: darkorange;
                                                                        background-image: -webkit-linear-gradient(top, darkorange, darkorange);
                                                                        background-image: -moz-linear-gradient(top, darkorange, darkorange);
                                                                        background-image: -ms-linear-gradient(top, darkorange, darkorange);
                                                                        background-image: -o-linear-gradient(top, darkorange, darkorange);
                                                                    ...
                                                                    <br /><br />
                                                                    <br /><br />
                                                                    Jika memerlukan informasi lebih lanjut dapat mengirimkan ke email: <a href="mailto:info@sim.id">info@sim.id </a> atau telepon di 0812-0000-0000
                                                                    ...
                                                                    Terima kasih,
                                                                    <br>
                                                                    <span style='color:#222222;'>Admin SIMPRO</span>
                                                                </p>
                                                            </div>
                                                        </div>
                                                    </td>
                                                                    ...
                                                                    <div class="contentEditableContainer contentTextEditable">
                                                                        <div class="contentEditable" align='center'>
                                                                            <p style='text-align:left;color:#000000;font-size:14px;font-weight:normal;line-height:20px;'>
                                                                                ...
                                                                                <h3 style="text-align:left; margin-top:-1px; color:#3cb0fd;">0812-0000-0000</h3>
                                                                            </p>
